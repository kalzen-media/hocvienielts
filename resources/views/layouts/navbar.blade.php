    ...
    <nav class="navbar navbar-expand-lg navbar-top  bg-white">
        <div class="container"><a class="navbar-brand" href="{{route('index')}}"><img src="{{asset('hocvienielts/logo.png')}}" alt="logo"></a><a class="navbar-toggle order-4 popup-inline" href="#navbar-mobile-style-1"><span></span><span></span><span></span></a>
            <ul class="nav navbar-nav order-2 ms-auto nav-no-opacity">
                ...
                <li class="nav-item navbar-dropdown"><a class="nav-link" href="#"><span>Test online</span></a>
                </li>
        ...
        <div class="navbar-wrapper">
            ...
            <div class="navbar-body">
                <ul class="nav navbar-nav navbar-nav-collapse">
                    <li class="nav-item navbar-collapse"><a class="nav-link" href="#navbarCollapseHome" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbarCollapseHome"><span>Trang chủ</span></a>
                        <div class="navbar-collapse-menu collapse" id="navbarCollapseHome">
                            <ul class="nav navbar-nav">
                                <li class="nav-item active"><a class="nav-link" href="{{ route('index') }}"><span>Trang chủ</span></a></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item navbar-collapse"><a class="nav-link" href="#navbarCollapseBlog" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbarCollapseBlog"><span>Tài liệu</span></a>
                    </li>
