    ...
    <nav class="navbar navbar-expand-lg navbar-top  bg-white">
        <div class="container"><a class="navbar-brand" href="{{route('index')}}"><img src="{{asset('hocvienielts/logo.png')}}" alt="logo"></a><a class="navbar-toggle order-4 popup-inline" href="#navbar-mobile-style-1"><span></span><span></span><span></span></a>
            <ul class="nav navbar-nav order-2 ms-auto nav-no-opacity">
                ...
                <li class="nav-item navbar-dropdown"><a class="nav-link" href="/danh-muc-tin-tuc/tin-tuc-tia"><span>Tin tức</span></a>
                </li>
    ...
    <div class="navbar navbar-mobile navbar-mobile-style-1 bg-white mfp-hide" id="navbar-mobile-style-1">
        <div class="navbar-wrapper">
            <div class="navbar-head"><a class="navbar-brand d-block d-md-none" href="{{route('index')}}"><img src="{{asset('hocvienielts/logo.png')}}" alt="logo"></a><a class="navbar-toggle popup-modal-dismiss" href="#"><span></span><span></span><span></span></a></div>
            ...
            <div class="navbar-footer">
                ...
                <ul class="list-group borderless font-size-15">
                    <li class="list-group-item">Email: <a href="mailto:mail@example.com">mail@example.com</a></li>
                    <li class="list-group-item">Phone: <a href="tel:12023580309">0987654321</a></li>
                </ul><!-- Social-->
    ...
    <div class="navbar navbar-topbar navbar-expand-xl bg-primary navbar-absolute top-0 d-none d-xl-flex">
        <div class="container">
            ...
            <ul class="nav nav-gap-sm navbar-nav nav-social ms-auto nav-no-opacity align-items-center">
                <li class="nav-item "><a class="nav-link text-white" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="7" height="14" fill="#fff">
                ...
                <li class="nav-item"><a class="nav-link text-white" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" fill="#fff">
                ...
                <li class="nav-item"><a class="nav-link text-white" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="12" fill="#fff">
                ...
                <li class="nav-item"><a class="nav-link text-white" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="13" fill="#fff">
