...
<head>
    ...
    <meta name="twitter:title" content="Học viện Ielts">
    <meta name="twitter:description" content="Học viện Ielts">
    ...
    <!-- Meta -->
    <meta name="description" content="Học viện Ielts">
            ...
            <div class="row gy-50">
                <div class="col-12 col-lg-3"><a class="d-block mb-30" href="{{ route('index')}}"><img
                    ...
                    <ul class="nav text-white align-items-center mb-20 nav-gap-md nav-no-opacity">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{  $shared_config['youtube']->value }}"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{  $shared_config['instagram']->value }}"><svg xmlns="http://www.w3.org/2000/svg"
